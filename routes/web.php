...
$router->post("scraping/syncAuthors", "ScrapingController@syncAuthors");
$router->post("scraping/syncArticles", "ScrapingController@syncArticles");
...
$router->get(
    "scraping/getJobProgress/{id}",
    "ScrapingController@getJobProgress"
);
$router->get("scraping/previewSyncAuthorsPage", "ScrapingController@previewSyncAuthorsPage");
$router->get("scraping/previewSyncArticlesPage", "ScrapingController@previewSyncArticlesPage");
$router->post("scraping/previewSyncAuthors", "ScrapingController@previewSyncAuthors");
$router->post("scraping/executeSyncAuthors", "ScrapingController@executeSyncAuthors");
// 404 handler
